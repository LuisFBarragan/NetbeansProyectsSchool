...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    private void calcularPosicion(Nodo n, int left, int right, int top) 
    {
      ...
      Dimension ld = (Dimension) subtreeSizes.get(n.getHizq());
      if (ld == null) 
          ld = empty;
      
      Dimension rd = (Dimension) subtreeSizes.get(n.getHder());
      if (rd == null) 
          rd = empty;
      ...
      calcularPosicion(n.getHizq(), Integer.MAX_VALUE, center - child2child/2, top + fm.getHeight() + parent2child);
      calcularPosicion(n.getHder(), center + child2child/2, Integer.MAX_VALUE, top + fm.getHeight() + parent2child);
    }
    ...
    private void dibujarArbol(Graphics2D g, Nodo n, int puntox, int puntoy, int yoffs) 
    {
     ...
     dibujarArbol(g, n.getHizq(), (int)(r.x + r.width/2), r.y + r.height, yoffs);
     dibujarArbol(g, n.getHder(), (int)(r.x + r.width/2), r.y + r.height, yoffs);
