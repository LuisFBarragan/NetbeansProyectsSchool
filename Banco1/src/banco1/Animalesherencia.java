...
class Especie {
            ...
            if (animal.get(i).getNombre().equals(name)) {
                if (animal.get(i).getEstado() == "peligro de extincion") {
                    ...
                    if (estadon == 1) {
                        ...
                        System.out.println("Da la fecha de extinsion");
    ...
    public void EstadoEspecifico(String EstadoEsp) {
        if (EstadoEsp.equals(this.Estado)) {
            System.out.println("" + Nombre + "\t" + NombreV + "\t" + Familia + "\t" + Poblacion + "\t" + Habitad + "\t" + Estado + "\t" + PeriodoExtincion);
        } else {
