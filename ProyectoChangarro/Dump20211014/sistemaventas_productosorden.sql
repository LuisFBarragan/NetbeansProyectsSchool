...
CREATE TABLE `productosorden` (
  ...
  `Monto` datetime NOT NULL,
  PRIMARY KEY (`idOrdenPedido`,`idProducto`),
  KEY `ProductoC_idx` (`idProducto`),
  CONSTRAINT `OrdenPedidosC` FOREIGN KEY (`idOrdenPedido`) REFERENCES `ordenpedido` (`idOrdenPedido`),
  CONSTRAINT `ProductoC` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idproductos`)
